...
const TennisScoreboard = () => {
  ...
  const handleScore = (player) => {
    //Defines a function that takes a player argument
    if (player === 1) {
      //Checks if player is equal to 1. (With other words: Checks if it's the first player)
      ...
      //Checks if player is equal to 2. (With other words: Checks if it's the second player)
  ...
  const resetScoresAndSets = () => {
    //Defines a function that will reset scores and sets
  ...
  const formatScore = (score) => {
    //Declares a function that takes a score argument. The function will be used to convert the numerical scores to their corresponding string representations
    if (score === 0) {
      //Checks if the score is equal to 0
      return 'Love'; //If it is, the function returns the string (Love)
    } else if (score === 1) {
      //If the score is not 0, this else if statement checks if the score is equal to 1
      return '15'; //If it is, the function returns the string (15)
    } else if (score === 2) {
      //If the score is not 0 or 1, this else if statement checks if the score is equal to 2
      return '30'; //If it is, the function returns the string (30)
    } else if (score === 3) {
      //If the score is not 0, 1 or 2, this else if statement checks if the score is equal to 3
      return '40'; //If it is, the function returns the string (40)
    } else if (score >= 4) {
      //If the score is not 0, 1, 2 or 3, this else if statement checks if the score is greater than or equal to 4
      return 'A'; //If it is, the function returns the string (A, aka Advantage)
    }
  };

  const determineGameWinner = () => {
    //Declares a function with no arguments. The function will be used to check whether a game has been won by either player
    if (player1Score >= 4 && player1Score - player2Score >= 2) {
      //Checks whether player1 has a score of at least 4 points and is at least 2 points ahead of player2
      ...
      //Checks wheter player2 has a score of at least 4 points and is at least 2 points ahead of player1
  ...
  const determineSetWinner = () => {
    //Declares a function with no arguments. The function will be used to check whether a set has been won by either player
    if (player1Score >= 6 && player1Score - player2Score >= 2) {
      //Checks wether player1 has a score of at least 6 points and is at least 2 points ahead of player2. If it is true, player1 is the winner of the set
      ...
      //Checks wether player2 has a score of at least 6 points and is at least 2 points ahead of player1. If it is true, player2 is the winner of the set
  ...
  const determineScore = () => {
    //Declares a arrowfunction with no arguments
    ...
    if (winner) {
      //If winner is true (with other words: a player has won the game)...
    ...
    if (player1Score === player2Score) {
      //This checks if the scores are tied
      if (player1Score >= 3) {
        //This checks if the scores are at least 3-3
      ...
      //If neither of the conditions above is true (if the scores are not tied), this else if function checks if either player has a score of at least 4 points
      ...
      if (scoreDiff === 1) {
        //If the score difference is 1 point, then the player who is in the lead has Advantage...
